...
#___________________________________________________wikidata___________________________________________
...
R = [treatment for _, treatment in medical_data if treatment is not None][:2]  # تقليل عدد العناصر في R لتتوافق مع ground_truth
